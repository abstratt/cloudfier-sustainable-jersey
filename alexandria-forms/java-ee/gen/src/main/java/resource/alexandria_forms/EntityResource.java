...
public class EntityResource {
    ...
    public Response getList() {
        String[] entityNames = {
            "userprofile.Profile", "applications.Person", "applications.CityOfficial", "applications.SystemAdministrator", "applications.Resident", "applications.DogLicenseApplication", "applications.Breed"
        };
        try {
