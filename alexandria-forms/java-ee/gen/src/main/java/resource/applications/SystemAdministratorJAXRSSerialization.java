    ...
    public static Map<String, Object> toExternalRepresentation(SystemAdministrator toRender, URI instancesURI, Feature... featureOptions) {
        ...
        if (features.contains(Feature.Links)) {
            ...
            if (toRender.getUserProfile() != null) {
                URI profileInstancesURI = instancesURI.resolve("../..").resolve("applications.SystemAdministrator/instances"); 
        ...
        resultTypeRef.put("fullName", "applications.SystemAdministrator");
        ...
        result.put("entityUri", instancesURI.resolve("../..").resolve("applications.SystemAdministrator").toString());
        return result;                    
    }
