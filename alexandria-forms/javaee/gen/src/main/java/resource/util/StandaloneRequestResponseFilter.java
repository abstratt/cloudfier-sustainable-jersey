...
import resource.alexandria_forms.EntityResource;
import resource.alexandria_forms.IndexResource;
...
public class StandaloneRequestResponseFilter implements ContainerRequestFilter, ContainerResponseFilter {
	...
	public StandaloneRequestResponseFilter() {
		entityManagerFactory = Persistence.createEntityManagerFactory("alexandria_forms-local");
	}
