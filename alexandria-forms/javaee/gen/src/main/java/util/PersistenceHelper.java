...
public class PersistenceHelper {
    ...
    public static EntityManager createTestSchema() {
        return Persistence.createEntityManagerFactory("alexandria_forms-test").createEntityManager();
    }
    
    public static EntityManager createSchema() {
        return Persistence.createEntityManagerFactory("alexandria_forms-schema-init").createEntityManager();
    }

    public static EntityManager createSchemaAndInitData() {
    	return Persistence.createEntityManagerFactory("alexandria_forms-schema-data-init").createEntityManager();
    }
    
    public static EntityManager openEntityManager() {
    	return Persistence.createEntityManagerFactory("alexandria_forms-local").createEntityManager();
    }
}