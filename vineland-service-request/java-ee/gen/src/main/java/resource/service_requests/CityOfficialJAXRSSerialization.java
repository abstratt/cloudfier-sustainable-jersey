    ...
    public static Map<String, Object> toExternalRepresentation(CityOfficial toRender, URI instancesURI, Feature... featureOptions) {
        ...
        if (features.contains(Feature.Links)) {
            ...
            if (toRender.getUserProfile() != null) {
                URI profileInstancesURI = instancesURI.resolve("../..").resolve("service_requests.CityOfficial/instances"); 
        ...
        resultTypeRef.put("fullName", "service_requests.CityOfficial");
        ...
        result.put("entityUri", instancesURI.resolve("../..").resolve("service_requests.CityOfficial").toString());
        return result;                    
    }
