    ...
    public static Map<String, Object> toExternalRepresentation(Resident toRender, URI instancesURI, Feature... featureOptions) {
        ...
        if (features.contains(Feature.Links)) {
            ...
            if (toRender.getUserProfile() != null) {
                URI profileInstancesURI = instancesURI.resolve("../..").resolve("service_requests.Resident/instances"); 
        ...
        resultTypeRef.put("fullName", "service_requests.Resident");
        ...
        result.put("entityUri", instancesURI.resolve("../..").resolve("service_requests.Resident").toString());
        return result;                    
    }
