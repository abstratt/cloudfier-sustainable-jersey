...
import resource.service_requests.EntityResource;
import resource.service_requests.IndexResource;
...
public class StandaloneRequestResponseFilter implements ContainerRequestFilter, ContainerResponseFilter {
	...
	public StandaloneRequestResponseFilter() {
		entityManagerFactory = Persistence.createEntityManagerFactory("service_requests-local");
	}
