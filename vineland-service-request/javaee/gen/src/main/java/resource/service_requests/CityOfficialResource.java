...
@Path("entities/service_requests.CityOfficial/")
...
public class CityOfficialResource {
    ...
    public Response getEntity() {
        try {
            String contents = EntityResourceHelper.getEntityRepresentation("service_requests.CityOfficial", uri.getRequestUri().resolve("..").toString());
            if (contents == null) {
