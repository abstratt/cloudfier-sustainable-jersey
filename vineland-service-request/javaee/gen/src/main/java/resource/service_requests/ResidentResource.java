...
@Path("entities/service_requests.Resident/")
...
public class ResidentResource {
    ...
    public Response getEntity() {
        try {
            String contents = EntityResourceHelper.getEntityRepresentation("service_requests.Resident", uri.getRequestUri().resolve("..").toString());
            if (contents == null) {
