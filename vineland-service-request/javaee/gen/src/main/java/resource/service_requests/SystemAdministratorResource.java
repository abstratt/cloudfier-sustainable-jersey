...
@Path("entities/service_requests.SystemAdministrator/")
...
public class SystemAdministratorResource {
    ...
    public Response getEntity() {
        try {
            String contents = EntityResourceHelper.getEntityRepresentation("service_requests.SystemAdministrator", uri.getRequestUri().resolve("..").toString());
            if (contents == null) {
