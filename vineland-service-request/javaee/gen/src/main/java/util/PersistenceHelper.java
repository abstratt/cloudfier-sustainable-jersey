...
public class PersistenceHelper {
    ...
    public static EntityManager createTestSchema() {
        return Persistence.createEntityManagerFactory("service_requests-test").createEntityManager();
    }
    
    public static EntityManager createSchema() {
        return Persistence.createEntityManagerFactory("service_requests-schema-init").createEntityManager();
    }

    public static EntityManager createSchemaAndInitData() {
    	return Persistence.createEntityManagerFactory("service_requests-schema-data-init").createEntityManager();
    }
    
    public static EntityManager openEntityManager() {
    	return Persistence.createEntityManagerFactory("service_requests-local").createEntityManager();
    }
}